...
function mostrarTweets(
	...
	$archivo_cache			= './mis_tweets.txt',	// Archivo para cache. (Por defecto: en el dir actual)
	...
	$get_tweets = $conexion->get("statuses/user_timeline", array("screen_name" => $_SESSION['usuario_twitter'], "count" => $tweets_a_mostrar, "exclude_replies" => true));
